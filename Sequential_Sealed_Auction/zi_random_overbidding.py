...
class Bidder:
    def __init__(self, num_rounds, strat_list, dist_max):
        ...
        self.max_bid_multiplier = numpy.random.uniform(1, 100)
    ...
    def get_bid(self):
        max_bid = self.valuation * self.max_bid_multiplier
        return random.uniform(0, max_bid)
...
numpy.savetxt('zi_random_overbidding_data.dat', all_results)