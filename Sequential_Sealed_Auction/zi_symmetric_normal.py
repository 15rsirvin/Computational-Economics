...
class Bidder:
    def __init__(self, num_rounds, strat_list, dist_loc, dist_scale):
    ...
    def draw_valuation(self):
        self.valuation = numpy.random.normal(self.dist_loc, self.dist_scale)
    ...
    def get_bid(self):
        bid =  numpy.random.uniform(0,self.valuation)
        return bid
...
def sequential_auction(args):
    ...
    for i in range(NUM_BIDDERS):
        bidders.append(Bidder(NUM_ROUNDS, strat_list, DIST_LOC, DIST_SIZE))
